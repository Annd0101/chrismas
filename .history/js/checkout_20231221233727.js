...
const addCartToHTML = () => {
  ...
  if (cart.length > 0) {
    ...
    let totalSummary = document.createElement('div')
    totalSummary.innerHTML = `            <li class="list-group-item d-flex justify-content-between">
    <span>Total (USD)</span>
    <strong>$${total}</strong>
</li>`
    summaryProduct.appendChild(totalSummary)
  }
};
