...
console.log(mainThumb.src);
console.log(firstThumb);
firstThumb.addEventListener("click", () => {
  mainThumb.src = "./assets/images/product-details/thumb-1.jpg";
});
secondThumb.addEventListener("click", () => {
  mainThumb.src = "./assets/images/product-details/thumb-2.jpg";
});
thirdThumb.addEventListener("click", () => {
  mainThumb.src = "./assets/images/product-details/thumb-3.jpg";
});
forthThumb.addEventListener("click", () => {
  mainThumb.src = "./assets/images/product-details/thumb-4.jpg";
});
